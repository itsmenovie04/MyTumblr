...
//create a pre defined username and password since we do not have dtabade
$acc_username = "Novie";
$acc_password = "Novie12345";
$acc_fullname = "Novie Dominguez";
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist'])===true){
		      				      echo "<div class='alert alert-danger' role='alert'> Username does not exist... </div>";
		      				       ...
		      				       echo "<div class='alert alert-info' role='alert'> You are still logged in. Please <a href='account.php'> click here </a> to proceeed... </div>";
